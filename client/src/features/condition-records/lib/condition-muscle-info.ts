...
export const MUSCLE_INFO_MAP: Record<string, MuscleInfo> = {
  가슴: {
    ...
    image: require('../../../assets/muscles/chest.png'),
    label: '가슴 (대흉근)',
  ...
  승모근: {
    ...
    image: require('../../../assets/muscles/trapezius.png'),
    label: '승모근',
  ...
  광배근: {
    ...
    image: require('../../../assets/muscles/lats.png'),
    label: '광배근',
  ...
  전삼각근: {
    ...
    image: require('../../../assets/muscles/front-deltoid.png'),
    label: '전삼각근 (앞 어깨)',
  ...
  측삼각근: {
    ...
    image: require('../../../assets/muscles/side-deltoid.png'),
    label: '측삼각근 (옆 어깨)',
  ...
  후삼각근: {
    ...
    image: require('../../../assets/muscles/rear-deltoid.png'),
    label: '후삼각근 (뒤 어깨)',
  ...
  상완이두근: {
    ...
    image: require('../../../assets/muscles/biceps.png'),
    label: '상완이두근 (이두근)',
  ...
  대퇴사두근: {
    ...
    image: require('../../../assets/muscles/quads.png'),
    label: '대퇴사두근 (앞 허벅지)',
  ...
  대퇴이두근: {
    ...
    image: require('../../../assets/muscles/hamstrings.png'),
    label: '대퇴이두근 (뒤 허벅지)',
  ...
  내전근: {
    ...
    image: require('../../../assets/muscles/adductors.png'),
    label: '내전근 (허벅지 안쪽)',
  ...
  복근: {
    ...
    image: require('../../../assets/muscles/abs.png'),
    label: '복근 (복직근)',
  ...
  허리: {
    ...
    image: require('../../../assets/muscles/lower-back.png'),
    label: '허리 (척추기립근)',
  ...
  종아리: {
    ...
    image: require('../../../assets/muscles/calves.png'),
    label: '종아리 (비복근/가자미근)',
