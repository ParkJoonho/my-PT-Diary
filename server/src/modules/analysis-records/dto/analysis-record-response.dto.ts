...
export enum AnalysisRecordType {
  Body = 'body',
  BodyComparison = 'body-comparison',
  Posture = 'posture',
  StateVector = 'state-vector',
}

export class AnalysisRecordDto {
  @ApiProperty({ example: 'record_123' })
  id!: string;
...
export class AnalysisRecordDetailDto extends AnalysisRecordDto {
  @ApiProperty({
    example: {
      bodyType: 'V',
      bodyTypeDescription: '상체가 상대적으로 발달한 체형이에요.',
